...
public:
   ...
   int find_view_edge(Mat crosstalk_map , double crosstalk_ratio, double crosstalk_area_threshold, double area_ratio, bool is_right);
   double current_cross_talk_right = 0.0;
   double current_cross_talk_left = 0.0;
